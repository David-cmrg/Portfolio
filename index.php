...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="https://avatars.githubusercontent.com/u/202826622?v=4">
        <meta property="og:url" content="https://david.cmrg.site/">
        <meta property="og:type" content="website">
    
        <meta name="robots" content="index, follow">
        <link rel="canonical" href="https://david.cmrg.site">
    ...
    <div class="language-selector">
        <div class="dropdown" tabindex="0" style="z-index: 100;">
            ...
            <div class="dropdown-content">
                <a href="javascript:void(0);" onclick="scrollToTop()">EN English</a>
    ...
    <body>
        ...
        <main>
            ...
            <div class="What-I-Do" style="margin-top:6rem;">
                ...
                <div id="projects">
                    <a class="section" id="MeinInfoKurs">
                        <h2>MeinInfoKurs</h2>
                    </a>
                    <a class="section" id="Linux">
                        <h5>Linux Environment</h5>
                    </a>
                    <a class="section" id="Networking">
                        <h3>Networking</h3>
                    </a>
                </div>
                ...
                <article style="width: fit-content; margin: 4rem auto 3rem auto !important;">
                    <p>My Email - kontakt@david.cmrg.site</p>
                </article>
                <div class="Icons">
        ...
        <script src="AboutDavid/CanvasBackground/JS/three.min.js"></script>
        <script src="AboutDavid/CanvasBackground/JS/jquery.min.js"></script>
        <script src="AboutDavid/CanvasBackground/JS/script.js"></script>
    </body>
</html>
